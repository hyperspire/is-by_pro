...
async fn main() -> std::io::Result<()> {
  ...
  let https_server = HttpServer::new(move || {
    ...
    App::new()
      ...
      .service(send_project_invite)
      .service(accept_project_invite)
      .service(send_project_dm)
      .service(get_project_dm_messages)
      ...
      .service(sitemap_index_xml)
      .service(sitemap_core_xml)
      .service(sitemap_users_xml)
